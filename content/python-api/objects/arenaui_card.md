...
<ul>
<li><strong>str body</strong>:  This is the text body of the card. (optional)</li>
<li><strong>str bodyAlign</strong>:  Body Text Alignment Allows [left, center, right, justify] Defaults to 'left' (optional)</li>
<li><strong>bool closeButton</strong>:  Show close button (optional)</li>
...
<li><strong>str img</strong>:  This image will be embedded alongside the body text. (optional)</li>

...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
<a href="./../arena.html">arena</a><wbr>.<a href="./../events.html">events</a><wbr>.event    </h1>
    ...
    <span class="name">Event</span><wbr>(<span class="base"><a href="../base_object.html#BaseObject">arena.base_object.BaseObject</a></span>):

        
    </div>
    <a class="headerlink" href="#Event"></a>
    
            <div class="docstring"><p>Event class. Wrapper around JSON for events.</p>
</div>
        ...
        <span class="name">Event</span><span class="signature pdoc-code condensed">(<span class="param"><span class="o">**</span><span class="n">kwargs</span></span>)</span>

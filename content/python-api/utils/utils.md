...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
<a href="./../../arena.html">arena</a><wbr>.<a href="./../utils.html">utils</a><wbr>.utils    </h1>
    ...
    <a class="headerlink" href="#Utils"></a>
                            ...
                            <div id="Utils.tuple_to_string" class="classattr">
                                <div class="attr function">
                    <div class="decorator">@classmethod</div>

        <span class="def">def</span>
        <span class="name">tuple_to_string</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">cls</span>, </span><span class="param"><span class="n">tup</span>, </span><span class="param"><span class="n">sep</span><span class="o">=</span><span class="s1">&#39; &#39;</span></span><span class="return-annotation">):</span></span>
    ...
    <a class="headerlink" href="#Utils.tuple_to_string"></a>
            ...
            <div class="docstring"><p>Turns a tuple into a string</p>
                            ...
                            <div id="Utils.agran" class="classattr">
                                <div class="attr function">
                    <div class="decorator">@classmethod</div>

        <span class="def">def</span>
        <span class="name">agran</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">cls</span>, </span><span class="param"><span class="n">float_num</span></span><span class="return-annotation">):</span></span>
    ...
    <a class="headerlink" href="#Utils.agran"></a>
            ...
            <div class="docstring"><p>Reduces floating point numbers to ARENA granularity</p>
                            ...
                            <div id="Utils.dict_key_replace" class="classattr">
                                <div class="attr function">
                    <div class="decorator">@classmethod</div>

        <span class="def">def</span>
        <span class="name">dict_key_replace</span><span class="signature pdoc-code condensed">(<span class="param"><span class="bp">cls</span>, </span><span class="param"><span class="n">d</span>, </span><span class="param"><span class="n">key</span>, </span><span class="param"><span class="n">new_key</span></span><span class="return-annotation">):</span></span>

...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
<a href="./../arena.html">arena</a><wbr>.<a href="./../attributes.html">attributes</a><wbr>.dynamic_body    </h1>
                ...
                <section id="DynamicBody">
                    <div class="attr class">
            
    <span class="def">class</span>
    <span class="name">DynamicBody</span><wbr>(<span class="base"><a href="attribute.html#Attribute">arena.attributes.attribute.Attribute</a></span>):
...
<ul>
<li><strong>float angularDamping</strong>:  Resistance to rotation. Defaults to '0.01' (optional)</li>
...
<li><strong>float linearDamping</strong>:  Resistance to movement. Defaults to '0.01' (optional)</li>
<li><strong>float mass</strong>:  Simulated mass of the object, &gt; 0. Defaults to '5' (optional)</li>
...
<li><strong>str type</strong>:  Define the result of collisions. Dynamic can be moved, Static cannot be moved. Allows [dynamic, static] Defaults to 'dynamic' (optional)</li>
</ul>
</div>


                            <div id="DynamicBody.__init__" class="classattr">
                                <div class="attr function">
            
        <span class="name">DynamicBody</span><span class="signature pdoc-code condensed">(<span class="param"><span class="nb">type</span><span class="o">=</span><span class="s1">&#39;static&#39;</span>, </span><span class="param"><span class="o">**</span><span class="n">kwargs</span></span>)</span>

        
    </div>
    <a class="headerlink" href="#DynamicBody.__init__"></a>
                            ...
                            <div class="inherited">
                                ...
                                <dd id="DynamicBody.add" class="function"><a href="../base_object.html#BaseObject.add">add</a></dd>
                <dd id="DynamicBody.json_encode" class="function"><a href="../base_object.html#BaseObject.json_encode">json_encode</a></dd>
                <dd id="DynamicBody.json" class="function"><a href="../base_object.html#BaseObject.json">json</a></dd>
    ...
    <span class="def">class</span>
    <span class="name">Physics</span><wbr>(<span class="base"><a href="#DynamicBody">DynamicBody</a></span>):
...
Usage: <code>physics=Physics(...)</code></p>
                            ...
                            <div class="inherited">
                                <h5>Inherited Members</h5>
                                <dl>
                                    <div><dt><a href="#DynamicBody">DynamicBody</a></dt>
                                <dd id="Physics.__init__" class="function"><a href="#DynamicBody.__init__">DynamicBody</a></dd>

...
<li><strong>str detailedUrl</strong>:  Alternative 'detailed' gltf model to load by URL. Defaults to '' (optional)</li>
<li><strong>bool retainCache</strong>:  Whether to skip freeing the detailed model from browser cache (default false). Defaults to 'False' (optional)</li>

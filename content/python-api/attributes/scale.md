...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
<a href="./../arena.html">arena</a><wbr>.<a href="./../attributes.html">attributes</a><wbr>.scale    </h1>
    ...
    <span class="name">Scale</span><wbr>(<span class="base"><a href="attribute.html#Attribute">arena.attributes.attribute.Attribute</a></span>):
...
<ul>
<li><strong>float|Iterable|Mapping x</strong>:  x Defaults to '1' (optional)</li>
<li><strong>float y</strong>:  y Defaults to '1' (optional)</li>
<li><strong>float z</strong>:  z Defaults to '1' (optional)</li>
</ul>
</div>


                            <div id="Scale.__init__" class="classattr">
    ...
    <a class="headerlink" href="#Scale.__init__"></a>
    
    

                            </div>
                            <div id="Scale.array" class="classattr">
    ...
    <a class="headerlink" href="#Scale.check_scale"></a>
                            ...
                            <div id="Scale.to_str" class="classattr">
                                <div class="attr function">
    ...
    <a class="headerlink" href="#Scale.to_str"></a>
                            ...
                            <div class="inherited">
                                ...
                                <dd id="Scale.add" class="function"><a href="../base_object.html#BaseObject.add">add</a></dd>
                <dd id="Scale.json_encode" class="function"><a href="../base_object.html#BaseObject.json_encode">json_encode</a></dd>
                <dd id="Scale.json" class="function"><a href="../base_object.html#BaseObject.json">json</a></dd>

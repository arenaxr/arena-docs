...
<div>
    <main class="pdoc">
            <section class="module-info">
                    <h1 class="modulename">
<a href="./../../arena.html">arena</a><wbr>.<a href="./../attributes.html">attributes</a><wbr>.click_listener    </h1>
                ...
                <section id="ClickListener">
                    <div class="attr class">
            
    <span class="def">class</span>
    <span class="name">ClickListener</span><wbr>(<span class="base"><a href="attribute.html#Attribute">arena.attributes.attribute.Attribute</a></span>):
...
<li><strong>bool enabled</strong>:  Publish events, set false to disable. Defaults to 'True' (optional)</li>
                            ...
                            <div id="ClickListener.__init__" class="classattr">
                                <div class="attr function">
            
        <span class="name">ClickListener</span><span class="signature pdoc-code condensed">(<span class="param"><span class="o">**</span><span class="n">kwargs</span></span>)</span>

        
    </div>
    <a class="headerlink" href="#ClickListener.__init__"></a>
                            ...
                            <div class="inherited">
                                ...
                                <dd id="ClickListener.add" class="function"><a href="../base_object.html#BaseObject.add">add</a></dd>
                <dd id="ClickListener.json_encode" class="function"><a href="../base_object.html#BaseObject.json_encode">json_encode</a></dd>
                <dd id="ClickListener.json" class="function"><a href="../base_object.html#BaseObject.json">json</a></dd>

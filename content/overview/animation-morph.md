...
animation for your 3D model. Note: you do not have to follow this
...
style="width:6in;height:3.81944in" />Add a shape key using the “+” sign
...
Rename this to something you can recognize. I am making my model blink,
so I will call my shape key “blink”.
...
typing “3”. Return to editing vertices by typing “1”. I will select the
upper two vertices of my model’s eye.
...
circle. I will move my two selected points
down.<img src="../../assets/img/overview/animation-morph/media/image12.png"
style="width:6in;height:3.4515in" />I will also move the lower three
points
up.<img src="../../assets/img/overview/animation-morph/media/image24.png"
style="width:6in;height:3.81944in" />Same for the other side!
...
style="width:6in;height:3.81944in" />You will notice that your shape key
...
style="width:6in;height:3.81944in" />Now we will animate the shape key
...
style="width:6in;height:3.81944in" />Set the End to a reasonable number
of frames. ARENA renders at 60 frames per second, so I will make my End
...
style="width:6in;height:3.81944in" />Then, drag the blue slider to 1
...
[<u>https://gltf-viewer.donmccurdy.com/</u>](https://gltf-viewer.donmccurdy.com/)
...
style="width:6in;height:3.58333in" /><img src="../../assets/img/overview/animation-morph/media/image2.png"
style="width:6in;height:3.91756in" />

**<u>Please make a cool animation (or multiple) for your scanned model
and export it as a .glb for usage in ARENA in the next section!</u>**

\[Optional\] See:

[<u>https://www.youtube.com/watch?v=e5I\_xim7rXQ</u>](https://www.youtube.com/watch?v=e5I_xim7rXQ)

[<u>https://www.youtube.com/watch?v=e675Ulc7QL4</u>](https://www.youtube.com/watch?v=e675Ulc7QL4)

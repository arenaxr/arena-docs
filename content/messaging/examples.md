...
```json
mosquitto_pub -h arena.andrew.cmu.edu -t realm/s/example/cube_1 -m '{"object_id" "cube_1", "action": "create", "type": "object", "data": {"object_type": "cube", "position": {"x": 1, "y": 1, "z": -1}, "click-listener": "", "goto-url": { "dest": "newtab", "on": "mousedown", "url": "http: www.eet.com"}}}'
```

...
| **sceneHeadModels** | [SceneHeadModels](attr-sceneHeadModels)[] | `[]` | Define the default head model(s) for the scene in a list. Users may still choose from the ARENA default list of head models as well. | No |
...
| **physics** | [Physics](attr-physics) |  | Clientside PhysX-based physics system. Required for all physx-* components | Yes |
| **ar-hit-test** | [ArHitTest](attr-ar-hit-test) |  | A-Frame AR Hit Test Settings. More properties at <a href='https://aframe.io/docs/1.5.0/components/ar-hit-test.html'>AR Hit Test</a> component. | No |
| **openvps** | [Openvps](attr-openvps) |  | Set an OpenVPS server to localize by camera image on mobile devices | No |

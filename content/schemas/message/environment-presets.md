...
|dressingVariance|[Vector3](Vector3)|```{'x': 1, 'y': 1, 'z': 1}```|Vector3|No|
...
|groundScale|[Vector3](Vector3)|```{'x': 1, 'y': 1, 'z': 1}```|Vector3|No|
...
|lightPosition|[Vector3](Vector3)|```{'x': 0, 'y': 1, 'z': -0.2}```|Vector3|No|

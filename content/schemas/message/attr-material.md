...
| **ambientOcclusionTextureOffset** | [Vector2](attr-vector2) | `{'x': 0, 'y': 0}` | Texture offset for the ambient occlusion map. | No |
| **ambientOcclusionTextureRepeat** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | Texture repeat for the ambient occlusion map. | No |
...
| **bumpTextureOffset** | [Vector2](attr-vector2) | `{'x': 0, 'y': 0}` | Texture offset for the bump map. Requires `shader: phong`. | No |
| **bumpTextureRepeat** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | Texture repeat for the bump map. Requires `shader: phong`. | No |
...
| **displacementTextureOffset** | [Vector2](attr-vector2) | `{'x': 0, 'y': 0}` | Texture offset for the displacement map. | No |
| **displacementTextureRepeat** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | Texture repeat for the displacement map. | No |
...
| **metalnessTextureOffset** | [Vector2](attr-vector2) | `{'x': 0, 'y': 0}` | Texture offset for the metalness map. | No |
| **metalnessTextureRepeat** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | Texture repeat for the metalness map. | No |
| **normalMap** | string |  | Normal map. Defines the angle of the surface at each point. Requires `shader: standard` or `phong`. | No |
| **normalScale** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | Scale of the effect of the normal map in the X and Y directions. | No |
| **normalTextureOffset** | [Vector2](attr-vector2) | `{'x': 0, 'y': 0}` | Texture offset for the normal map. | No |
| **normalTextureRepeat** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | Texture repeat for the normal map. | No |
| **npot** | boolean | `False` | Use settings for non-power-of-two (NPOT) texture. | No |
| **offset** | [Vector2](attr-vector2) | `{'x': 0, 'y': 0}` | Texture offset to be used. | No |
...
| **repeat** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | How many times a texture (defined by src) repeats in the X and Y direction. | No |
...
| **roughnessTextureOffset** | [Vector2](attr-vector2) | `{'x': 0, 'y': 0}` | Texture offset for the roughness map. | No |
| **roughnessTextureRepeat** | [Vector2](attr-vector2) | `{'x': 1, 'y': 1}` | Texture repeat for the roughness map. | No |

...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "cube_1", "action": "update", "type": "object", "data": {"material": {"transparent": true, "opacity": 0.5}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "cube_1", "action": "update", "type": "object", "data": {"position": {"x": 2, "y": 2, "z": -1}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "cube_1", "action": "update", "type": "object", "data": {"rotation": {"x": 60, "y": 2, "z": 3}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "cube_1", "action": "delete"}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "image_floor", "action": "create", "type": "object", "data": {"object_type": "image", "position": {"x": 0, "y": 0, "z": 0.4}, "rotation": {"x": -0.7, "y": 0, "z": 0, "w": 0.7}, "url": "images/floor.png", "scale": {"x": 12, "y": 12, "z": 2}, "material": {"repeat": {"x": 4, "y": 4}}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "image_2", "action": "update", "type": "object", "data": {"material": {"src": "https://arenaxr.org/abstract/downtown.png"}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "gltf-model_1", "action": "create", "type": "object", "data": {"object_type": "gltf-model", "url": "https://arenaxr.org/models/Duck.glb", "position": {"x": 0, "y": 1, "z": -4}, "rotation": {"x": 0, "y": 0, "z": 0, "w": 1}, "scale": {"x": 1, "y": 1, "z": 1}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "camera_1234567890_er1k", "action": "update", "type": "rig", "data": {"position": {"x": 1, "y": 1, "z": 1}, "rotation": {"x": 0.1, "y": 0, "z": 0, "w": 1} }}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id":"camera_1234567890_er1k","action":"update","type":"camera-override","data":{"object_type":"camera","position":{"x":1.692,"y":1.6,"z":4.371},"rotation":{"x":0.003,"y":-0.003,"z":0,"w":1}}}'
```
...
arena-py-pub -mh arenaxr.org -s example -m '{"object_id":"camera_1234567890_er1k","action":"update","type":"camera-override","data":{"object_type":"look-at","target":"cone_587431"}}'

arena-py-pub -mh arenaxr.org -s example -m '{"object_id":"camera_1234567890_er1k","action":"update","type":"camera-override","data":{"object_type":"look-at","target":{"x": 0.467, "y": 2.066, "z": -1.027}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "cube_1", "action": "update", "type": "object", "data": {"click-listener": "enable"}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "env", "action": "update", "type": "object", "data": {"environment": {"preset": "arches"}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "box_3", "action": "update", "type": "object", "data": {"dynamic-body": {"type": "dynamic"}}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "scene", "action": "update", "type": "object", "data": {"stats": true}}'
```
...
```json
arena-py-pub -mh arenaxr.org -s example -m '{"object_id": "scene", "action": "update", "type": "object", "data": {"vr-mode-ui": {"enabled": false}}}'
```
